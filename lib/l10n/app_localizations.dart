...
abstract class AppLocalizations {
  ...
  /// No description provided for @generalCharacteristics.
  ///
  /// In pt, this message translates to:
  /// **'Características Gerais'**
  String get generalCharacteristics;
  ...
  /// No description provided for @noPokemon.
  ///
  /// In pt, this message translates to:
  /// **'Nenhum Pokémon selecionado.'**
  String get noPokemon;

  /// No description provided for @raMatricula.
  ///
  /// In pt, this message translates to:
  /// **'RA / Matrícula'**
  String get raMatricula;
  ...
  /// No description provided for @advancedTraining.
  ///
  /// In pt, this message translates to:
  /// **'Treinamento Avançado Pokémon'**
  String get advancedTraining;
  ...
  /// No description provided for @filterEvolution.
  ///
  /// In pt, this message translates to:
  /// **'Estágio de Evolução'**
  String get filterEvolution;
  ...
  /// No description provided for @evolutionBase.
  ///
  /// In pt, this message translates to:
  /// **'Forma Básica'**
  String get evolutionBase;

  /// No description provided for @evolutionFirst.
  ///
  /// In pt, this message translates to:
  /// **'1ª Evolução'**
  String get evolutionFirst;

  /// No description provided for @evolutionSecond.
  ///
  /// In pt, this message translates to:
  /// **'2ª Evolução'**
  String get evolutionSecond;
